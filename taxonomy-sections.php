<?php get_header(); ?>
  <div class="sixteen columns">
    <div class="alpha eleven columns">
      ...
      ?><h2 class="archive_title"><div class="browse_text">Browse Our Dictionary Alphabetically</div>Section <?php echo $term->name; ?></h2>
      <?php
      if ( have_posts() ) :
      ...
      <h2 style="font-style:italic;">No entries were found under <?php echo $term->name; ?>.</h2>
        <p>Please try another section or use the search tool above.</p>
      <?php endif; ?>
    </div>
