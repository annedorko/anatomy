...
/******************Change this*******************/
$api_url = 'http://anatomytheme.com/updates/api/';
/************************************************/
...
add_filter('pre_set_site_transient_update_themes', 'anatomy_check_for_update');

function anatomy_check_for_update( $checked_data ) {
...
add_filter('themes_api', 'anatomy_my_theme_api_call', 10, 3);

function anatomy_my_theme_api_call($def, $action, $args) {
